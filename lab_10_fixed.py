...
def main():
    ...
    # Only 2 rows of subplots, leaving room for the text box above
    gs = fig.add_gridspec(2, 4,
                          hspace=0.55, wspace=0.35,
                          top=0.82,   # leave space for the theory text above
